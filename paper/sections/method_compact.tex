...
\begin{equation}
  ...
  \label{eq:town-cost}
\end{equation}
which is \textbf{2.3$\times$} cheaper than \texttt{think@512} (460 tokens).
...
For (2): $\mathbb{E}[T_{\method{}}] \approx 199 < 460 = \mathbb{E}[T_{\mathrm{think}}(B_2)]$ since most samples ($p \approx 0.89$) resolve at $\bar{t}_1 \approx 133$ tokens.
